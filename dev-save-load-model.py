...
directory = 'D:\\TU Delft\\NY\\Data Processing\\Try\\Develop\\lstm.mod'
torch.save(lstm, directory)
lstx = torch.load(directory)
print(lstx.eval())
lstm_test = TestModel(lstx, test_dataloader, max_dataloader )
...
gclstm, gclstm_loss = TrainModel(gclstm, train_dataloader, valid_dataloader, num_epochs=10)
